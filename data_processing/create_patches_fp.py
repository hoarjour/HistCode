...
if __name__ == '__main__':
    ...
    patch_save_dir = os.path.join(args.save_dir, 'patches', args.data_type)
    mask_save_dir = os.path.join(args.save_dir, 'masks', args.data_type)
    stitch_save_dir = os.path.join(args.save_dir, 'stitches', args.data_type)
